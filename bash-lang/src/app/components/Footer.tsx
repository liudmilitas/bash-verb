...
function Footer() {
  return (
    <footer className="flex flex-col w-full max-w-[800px] items-center justify-center text-white p-2 mt-8 drop-shadow-lg fill-white">
      ...
      <div className="flex p-2">
        ...
        >
          <svg className="w-6 h-6 mr-1 fill-inherit" viewBox="0 0 64 64" width="24" height="24">
